    ...
    <div class="col-sm-12">
      <div class="col-sm-6">
        <div class="col-sm-12 text-center fail-head">
          <img src="{{url('public/assets/img/success-wee.png')}}" height="220px" class="failT100">
          <h3>Recharge successfull. </h3>
          <p>
      ...
      <div class="col-sm-6 med-block">
        <img src="{{url('public/assets/img/payment-succ.png')}}" class="img-responsive padT50 fail-mx">
      </div>
    </div>
