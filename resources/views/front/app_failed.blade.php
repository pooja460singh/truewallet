...
<head>
   ...
   <title>TrueJourney</title>
   <link href="{{url('public/main.css')}}" rel="stylesheet">
   <link href="{{url('public/assets/css/color.css')}}" rel="stylesheet" id="colors">
...
<body class="fail-bg">
    ...
    <div class="col-sm-12">
      <div class="col-sm-6">
        <div class="col-sm-12 text-center fail-head">
          <img src="{{url('public/assets/img/wee.png')}}" height="220px" class="failT100">
          <h3>Your payment failed due to a temporary technical issue.Please try after some time</h3>
          <p>
Note:if money has left your account, it will be refund within 1 working day(BHIM UPI/bank account) or 9 days(card)..
             <!--<button><a href="{{url('/')}}">Home</a></button>-->
          </p>
        </div>
      </div>
      <div class="col-sm-6 med-block">
        <img src="{{url('public/assets/img/payment-fail.png')}}" class="img-responsive padT50 fail-mx">
      </div>
    </div>
